  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const turtlesim::srv::Kill_Request & ros_message =
    *(const turtlesim::srv::Kill_Request *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::Kill_Request_ * dds_message = turtlesim::srv::dds_::Kill_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::Kill_Request & ros_message =
    *(turtlesim::srv::Kill_Request *)untyped_ros_message;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Kill_Request__handle;
}
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const turtlesim::srv::Kill_Response & ros_message =
    *(const turtlesim::srv::Kill_Response *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::Kill_Response_ * dds_message = turtlesim::srv::dds_::Kill_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::Kill_Response & ros_message =
    *(turtlesim::srv::Kill_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (turtlesim::srv::dds_::Kill_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Kill_Response__handle;
}
...
const char * destroy_requester__Kill(
...
int64_t send_request__Kill(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = turtlesim::srv::Kill_Request;
  using RequesterType = connext::Requester<
    turtlesim::srv::dds_::Kill_Request_,
    turtlesim::srv::dds_::Kill_Response_
  >;
  connext::WriteSample<
    turtlesim::srv::dds_::Kill_Request_> request;
...
const char * destroy_replier__Kill(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    turtlesim::srv::dds_::Kill_Response_
  >;
  using ROSResponseType = turtlesim::srv::Kill_Response;
...
{
  using ROSResponseType = const turtlesim::srv::Kill_Response;
  using ReplierType = connext::Replier<
    turtlesim::srv::dds_::Kill_Request_,
    turtlesim::srv::dds_::Kill_Response_
  >;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Kill__handle;
}
