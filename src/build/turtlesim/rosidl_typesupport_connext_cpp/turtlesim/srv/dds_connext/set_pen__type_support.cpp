  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const turtlesim::srv::SetPen_Request & ros_message =
    *(const turtlesim::srv::SetPen_Request *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::SetPen_Request_ * dds_message = turtlesim::srv::dds_::SetPen_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::SetPen_Request & ros_message =
    *(turtlesim::srv::SetPen_Request *)untyped_ros_message;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_SetPen_Request__handle;
}
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const turtlesim::srv::SetPen_Response & ros_message =
    *(const turtlesim::srv::SetPen_Response *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::SetPen_Response_ * dds_message = turtlesim::srv::dds_::SetPen_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::SetPen_Response & ros_message =
    *(turtlesim::srv::SetPen_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (turtlesim::srv::dds_::SetPen_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_SetPen_Response__handle;
}
...
const char * destroy_requester__SetPen(
...
int64_t send_request__SetPen(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = turtlesim::srv::SetPen_Request;
  using RequesterType = connext::Requester<
    turtlesim::srv::dds_::SetPen_Request_,
    turtlesim::srv::dds_::SetPen_Response_
  >;
  connext::WriteSample<
    turtlesim::srv::dds_::SetPen_Request_> request;
...
const char * destroy_replier__SetPen(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    turtlesim::srv::dds_::SetPen_Response_
  >;
  using ROSResponseType = turtlesim::srv::SetPen_Response;
...
{
  using ROSResponseType = const turtlesim::srv::SetPen_Response;
  using ReplierType = connext::Replier<
    turtlesim::srv::dds_::SetPen_Request_,
    turtlesim::srv::dds_::SetPen_Response_
  >;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_SetPen__handle;
}
