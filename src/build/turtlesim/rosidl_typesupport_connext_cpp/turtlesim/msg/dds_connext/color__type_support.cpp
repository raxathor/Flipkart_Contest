...
#include "turtlesim/msg/color__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const turtlesim::msg::Color & ros_message =
    *(const turtlesim::msg::Color *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::msg::dds_::Color_ * dds_message = turtlesim::msg::dds_::Color_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::msg::Color & ros_message =
    *(turtlesim::msg::Color *)untyped_ros_message;
...
{
  return &turtlesim::msg::typesupport_connext_cpp::_Color__handle;
}
