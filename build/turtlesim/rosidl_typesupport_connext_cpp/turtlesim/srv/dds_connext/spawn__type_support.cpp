  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const turtlesim::srv::Spawn_Request & ros_message =
    *(const turtlesim::srv::Spawn_Request *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::Spawn_Request_ * dds_message = turtlesim::srv::dds_::Spawn_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::Spawn_Request & ros_message =
    *(turtlesim::srv::Spawn_Request *)untyped_ros_message;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Spawn_Request__handle;
}
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const turtlesim::srv::Spawn_Response & ros_message =
    *(const turtlesim::srv::Spawn_Response *)untyped_ros_message;

  // create a respective connext dds type
  turtlesim::srv::dds_::Spawn_Response_ * dds_message = turtlesim::srv::dds_::Spawn_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim::srv::Spawn_Response & ros_message =
    *(turtlesim::srv::Spawn_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (turtlesim::srv::dds_::Spawn_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Spawn_Response__handle;
}
...
const char * destroy_requester__Spawn(
...
int64_t send_request__Spawn(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = turtlesim::srv::Spawn_Request;
  using RequesterType = connext::Requester<
    turtlesim::srv::dds_::Spawn_Request_,
    turtlesim::srv::dds_::Spawn_Response_
  >;
  connext::WriteSample<
    turtlesim::srv::dds_::Spawn_Request_> request;
...
const char * destroy_replier__Spawn(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    turtlesim::srv::dds_::Spawn_Response_
  >;
  using ROSResponseType = turtlesim::srv::Spawn_Response;
...
{
  using ROSResponseType = const turtlesim::srv::Spawn_Response;
  using ReplierType = connext::Replier<
    turtlesim::srv::dds_::Spawn_Request_,
    turtlesim::srv::dds_::Spawn_Response_
  >;
...
{
  return &turtlesim::srv::typesupport_connext_cpp::_Spawn__handle;
}
